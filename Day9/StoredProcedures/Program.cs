...
namespace StoredProcedures
{
    internal class Program
    {
        ...
        {
            string _conStr = "Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=DataB;Integrated Security=True;Pooling=False;Encrypt=True;Trust Server Certificate=False";
